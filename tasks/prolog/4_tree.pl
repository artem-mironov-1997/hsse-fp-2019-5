...
% Empty_result = empty,
% List = [5, 11, 4, 2, 6, 9, 7, 5, 2],
% Result = instant(5, instant(4, instant(2, instant(2, empty, empty), empty), instant(5, empty, empty)), instant(9, instant(7, instant(6, empty, empty), empty), instant(11, empty, empty)))
